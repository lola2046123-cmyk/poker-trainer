...
const allQuestions = [
  ...
  // ========== 位置 (Position) 核心策略 24 题：UTG/UTG+1 紧、HJ/CO 稍放、BTN 偷盲、SB/BB 不硬防 ==========
  { "level_id": 801, "title": "【位置】UTG 拿 QJo", "scenario": "你在【枪口位 UTG】第一个行动。拿到 Q♠ J♦。底池只有盲注。", "hand": ["Qs", "Jd"], "board": [], "posId": "node-utg", "options": [{ "action": "加注 (Raise)", "is_correct": false, "hp_change": -12, "sharky_emotion": "angry", "sharky_feedback": "在这里加注就要做好被 3-bet 的心理准备。别拿那张破 QJ 出来晃悠——后面随便一个 3-bet 你就得弃，白送筹码。" }, { "action": "弃牌 (Fold)", "is_correct": true, "hp_change": 12, "sharky_emotion": "cool", "sharky_feedback": "UTG/UTG+1 早位要最紧。QJo 容易被 AK/AQ/KQ 主导，被 3-bet 又只能弃。扔了保平安。" }] },
  { "level_id": 802, "title": "【位置】UTG+1 拿 ATo", "scenario": "你在【UTG+1】第二行动。拿到 A♣ 10♦。前面 UTG 弃牌。", "hand": ["Ac", "Td"], "board": [], "posId": "node-utg1", "options": [{ "action": "加注开池", "is_correct": false, "hp_change": -10, "sharky_emotion": "facepalm", "sharky_feedback": "早位加注就要做好被 3-bet 的准备。ATo 后面还有 7 个人，被 AK/AQ/AJ 主导或 3-bet 弃牌都很亏。" }, { "action": "弃牌 (Fold)", "is_correct": true, "hp_change": 10, "sharky_emotion": "cool", "sharky_feedback": "UTG+1 也是早位，手牌要够强。ATo 勉强可玩但多数体系建议弃牌，等好位置再玩。" }] },
  { "level_id": 803, "title": "【位置】枪口位范围", "scenario": "9 人桌，【枪口位 UTG】第一个行动。整体手牌范围应该？", "hand": [], "board": [], "posId": "node-utg", "options": [{ "action": "最紧，只玩顶级牌", "is_correct": true, "hp_change": 12, "sharky_emotion": "cool", "sharky_feedback": "枪口位信息最少、最容易被后位 3-bet，范围必须最紧。别在早位晃悠边缘牌。" }, { "action": "和庄位一样宽", "is_correct": false, "hp_change": -12, "sharky_emotion": "facepalm", "sharky_feedback": "庄位最后行动可以玩宽，枪口最先行动必须紧。位置决定范围。" }] },
  { "level_id": 804, "title": "【位置】BTN 偷盲", "scenario": "你在【庄家位 BTN】。前面所有人弃牌，只剩 SB、BB。你拿到 7♦ 2♣。", "hand": ["7d", "2c"], "board": [], "posId": "node-btn", "options": [{ "action": "加注 (Raise) 偷盲", "is_correct": true, "hp_change": 12, "sharky_emotion": "laugh", "sharky_feedback": "这就是你的领地。只要没人加注，哪怕是空气牌也能考虑偷一波。72o 在 BTN 偷盲是标准操作。" }, { "action": "弃牌 (Fold)", "is_correct": false, "hp_change": -10, "sharky_emotion": "facepalm", "sharky_feedback": "前面全弃、你最后行动，不偷盲等于把死钱送给别人。BTN 要利用位置。" }] },
  { "level_id": 805, "title": "【位置】大盲 K9o 防守", "scenario": "你在【大盲 BB】。庄位 BTN 加注，其他人弃牌，只剩你和他单挑。你拿 K♠ 9♦。", "hand": ["Ks", "9d"], "board": [], "posId": "node-bb", "options": [{ "action": "跟注防守", "is_correct": false, "hp_change": -10, "sharky_emotion": "angry", "sharky_feedback": "不要为了那点底池强行防守。K9o 对 BTN 加注范围常被主导，翻牌后没位置很难打。除非你觉得自己是反杀王，否则弃牌更稳。" }, { "action": "弃牌 (Fold)", "is_correct": true, "hp_change": 10, "sharky_emotion": "cool", "sharky_feedback": "盲注位不要硬防。K9o 对单次加注可弃，省下的筹码比勉强跟注送钱强。" }] },
  { "level_id": 806, "title": "【位置】小盲 83o 被加注", "scenario": "你在【小盲 SB】。有人加注到 2.5bb。你拿 8♣ 3♦。", "hand": ["8c", "3d"], "board": [], "posId": "node-sb", "options": [{ "action": "跟注看翻牌", "is_correct": false, "hp_change": -12, "sharky_emotion": "facepalm", "sharky_feedback": "不要为了那点底池强行防守。83o 是最烂牌之一，小盲位置又最差，跟注等于送钱。" }, { "action": "弃牌 (Fold)", "is_correct": true, "hp_change": 10, "sharky_emotion": "cool", "sharky_feedback": "SB/BB 别硬防烂牌。除非赔率极好或牌力够，弃牌是正解。" }] },
  { "level_id": 807, "title": "【位置】谁位置最好", "scenario": "9 人桌，翻牌前按行动顺序：UTG → … → BTN → SB → BB。哪个位置最有利？", "hand": [], "board": [], "posId": "node-btn", "options": [{ "action": "庄家位 (BTN)", "is_correct": true, "hp_change": 10, "sharky_emotion": "cool", "sharky_feedback": "BTN 最后行动，信息最多，可以玩更多牌、偷盲、控池。这就是你的领地。" }, { "action": "枪口位 (UTG)", "is_correct": false, "hp_change": -10, "sharky_emotion": "facepalm", "sharky_feedback": "UTG 最先行动，最不利。位置好 = 最后行动。" }] },
  { "level_id": 808, "title": "【位置】UTG 加注后被 3-bet", "scenario": "你在 UTG 加注，后面有人 3-bet。你拿 K♠ Q♦。", "hand": ["Ks", "Qd"], "board": [], "posId": "node-utg", "options": [{ "action": "跟注", "is_correct": false, "hp_change": -12, "sharky_emotion": "angry", "sharky_feedback": "在这里加注就要做好被 3-bet 的心理准备。KQo 被 3-bet 后常面对 AK/AA/KK/QQ，你被主导或翻牌后难打，多数体系倾向弃牌。" }, { "action": "弃牌 (Fold)", "is_correct": true, "hp_change": 12, "sharky_emotion": "cool", "sharky_feedback": "早位加注被 3-bet = 被隔离进单挑，对方范围很强。KQo 弃牌不丢人。" }] },

  { "level_id": 809, "title": "【位置】HJ 前面都弃牌 AJo", "scenario": "你在【劫持位 HJ】。前面 UTG、UTG+1、MP 都弃牌。你拿 A♠ J♦。", "hand": ["As", "Jd"], "board": [], "posId": "node-hj", "options": [{ "action": "加注 (Raise)", "is_correct": true, "hp_change": 12, "sharky_emotion": "cool", "sharky_feedback": "你前面的都弃牌了？那你可以稍微放肆一点。AJo 在 HJ 开池没问题，但后面还有 CO、BTN 盯着你呢，被 3-bet 要准备好弃牌。" }, { "action": "弃牌", "is_correct": false, "hp_change": -10, "sharky_emotion": "facepalm", "sharky_feedback": "前面没人进池，HJ 可以开池加注。AJo 够强，别浪费。" }] },
  { "level_id": 810, "title": "【位置】CO 前面全弃 KTs", "scenario": "你在【关煞位 CO】。前面全弃牌，只剩 BTN、SB、BB。你拿 K♥ 10♥。", "hand": ["Kh", "Th"], "board": [], "posId": "node-co", "options": [{ "action": "加注 (Raise)", "is_correct": true, "hp_change": 12, "sharky_emotion": "cool", "sharky_feedback": "前面都弃了，CO 可以放宽开池。KTs 同花不错，但后面还有 BTN 盯着你，加注后若被 3-bet 要能弃。" }, { "action": "弃牌", "is_correct": false, "hp_change": -10, "sharky_emotion": "facepalm", "sharky_feedback": "CO 位置不错，KTs 值得加注。别太怂。" }] },
  { "level_id": 811, "title": "【位置】BTN 前面全弃 96s", "scenario": "你在【庄家位 BTN】。前面所有人弃牌。你拿 9♥ 6♥。", "hand": ["9h", "6h"], "board": [], "posId": "node-btn", "options": [{ "action": "加注偷盲", "is_correct": true, "hp_change": 12, "sharky_emotion": "laugh", "sharky_feedback": "这就是你的领地。只要没人加注，哪怕是 96s 这种边缘牌也能考虑偷一波。同花连张还有发展。" }, { "action": "弃牌", "is_correct": false, "hp_change": -10, "sharky_emotion": "facepalm", "sharky_feedback": "BTN 对盲注单挑，96s 偷盲是标准。不偷等于送钱。" }] },
  { "level_id": 812, "title": "【位置】BTN T8o 偷盲", "scenario": "你在 BTN，前面全弃。你拿 10♦ 8♣。", "hand": ["Td", "8c"], "board": [], "posId": "node-btn", "options": [{ "action": "加注 (Raise)", "is_correct": true, "hp_change": 10, "sharky_emotion": "cool", "sharky_feedback": "BTN 空气牌也能偷。T8o 对两个盲注有弃牌率，加注是正解。" }, { "action": "弃牌", "is_correct": false, "hp_change": -10, "sharky_emotion": "facepalm", "sharky_feedback": "庄位不偷盲，等于把死钱留给别人。" }] },
  { "level_id": 813, "title": "【位置】SB 拿 22 被 BTN 加注", "scenario": "你在【小盲 SB】。BTN 加注，BB 弃牌，只剩你和 BTN。你拿 2♦ 2♣。", "hand": ["2d", "2c"], "board": [], "posId": "node-sb", "options": [{ "action": "平跟 (Call)", "is_correct": false, "hp_change": -10, "sharky_emotion": "facepalm", "sharky_feedback": "小对子对单次加注可以跟注 set mining，但 SB 位置最差，跟注后翻牌后你先动。3-bet 或弃牌往往比平跟好。" }, { "action": "3-bet 或弃牌", "is_correct": true, "hp_change": 10, "sharky_emotion": "cool", "sharky_feedback": "不要为了底池强行平跟。22 在 SB 要么 3-bet 抢主动权，要么弃牌。平跟最被动。" }] },
  { "level_id": 814, "title": "【位置】BB 单挑 CO 拿 Q9s", "scenario": "你在【大盲 BB】。CO 加注，其他人弃牌，你与 CO 单挑。你拿 Q♥ 9♥。", "hand": ["Qh", "9h"], "board": [], "posId": "node-bb", "options": [{ "action": "跟注 (Call)", "is_correct": true, "hp_change": 10, "sharky_emotion": "cool", "sharky_feedback": "单挑大盲对 CO，Q9s 有赔率可以跟注。但不要为了底池硬防——若加注很大可弃。" }, { "action": "弃牌", "is_correct": false, "hp_change": -8, "sharky_emotion": "facepalm", "sharky_feedback": "已有 1bb 在池里，Q9s 对单次加注跟注看翻牌是合理防守。" }] },
  { "level_id": 815, "title": "【位置】BTN 拿 77 对 UTG 加注", "scenario": "UTG 加注，中间都弃牌。你在【BTN】拿 7♦ 7♣。", "hand": ["7d", "7c"], "board": [], "posId": "node-btn", "options": [{ "action": "跟注 (Call)", "is_correct": true, "hp_change": 12, "sharky_emotion": "cool", "sharky_feedback": "位置好可玩。77 对 UTG 加注跟注看翻牌、中 set 拿价值是标准。3-bet 也可，看风格。" }, { "action": "弃牌", "is_correct": false, "hp_change": -12, "sharky_emotion": "facepalm", "sharky_feedback": "BTN 对 UTG 有位置，77 值得跟注或 3-bet，别随便弃。" }] },
  { "level_id": 816, "title": "【位置】HJ 开池范围 vs UTG", "scenario": "同样 9 人桌，【HJ】开池加注的范围，应该比【UTG】？", "hand": [], "board": [], "posId": "node-hj", "options": [{ "action": "宽一点", "is_correct": true, "hp_change": 10, "sharky_emotion": "cool", "sharky_feedback": "HJ 前面弃牌多，后面只剩 CO/BTN/SB/BB，可以稍微放肆一点。但后面还有按钮位盯着你呢。" }, { "action": "一样紧", "is_correct": false, "hp_change": -10, "sharky_emotion": "facepalm", "sharky_feedback": "位置越靠后、前面弃牌越多，开池范围可以越宽。" }] },

  { "level_id": 817, "title": "【位置】CO 拿 AQ 对 UTG 加注", "scenario": "UTG 加注。你在【CO】拿 A♠ Q♦。", "hand": ["As", "Qd"], "board": [], "posId": "node-co", "options": [{ "action": "3-bet 隔离", "is_correct": true, "hp_change": 12, "sharky_emotion": "cool", "sharky_feedback": "AQ 对 UTG 可 3-bet 隔离：把局面打成单挑、用你的强范围打他较宽的开池范围。跟注也可，看筹码深度和对手。" }, { "action": "弃牌", "is_correct": false, "hp_change": -12, "sharky_emotion": "facepalm", "sharky_feedback": "AQ 够强，3-bet 或跟注都行，不能弃。" }] },
  { "level_id": 818, "title": "【位置】BTN 拿 AJs 被 SB 3-bet", "scenario": "你 BTN 加注，【小盲 SB】3-bet，BB 弃牌。你拿 A♥ J♥。", "hand": ["Ah", "Jh"], "board": [], "posId": "node-btn", "options": [{ "action": "跟注或 4-bet", "is_correct": true, "hp_change": 12, "sharky_emotion": "cool", "sharky_feedback": "BTN 对 SB 有位置优势。AJs 对 SB 3-bet 可跟注看翻牌，或 4-bet  bluff/价值混合。别随便弃。" }, { "action": "弃牌", "is_correct": false, "hp_change": -12, "sharky_emotion": "facepalm", "sharky_feedback": "你有位置，AJs 值得继续。弃牌太弱。" }] },
  { "level_id": 819, "title": "【位置】什么是隔离", "scenario": "「隔离 (Isolation)」在德扑里通常指？", "hand": [], "board": [], "posId": "node-co", "options": [{ "action": "加注/3-bet 让局面变成单挑，用强范围打对手", "is_correct": true, "hp_change": 12, "sharky_emotion": "cool", "sharky_feedback": "隔离 = 通过加注或 3-bet 让其他人弃牌，你和对手单挑。你的范围强、对方跟注范围常较弱，你占优。" }, { "action": "把对手逼出底池", "is_correct": false, "hp_change": -10, "sharky_emotion": "facepalm", "sharky_feedback": "隔离是「打成单挑」而不是逼人出局。目的是用范围优势单挑。" }] },
  { "level_id": 820, "title": "【位置】SB 拿 AA 有人加注", "scenario": "你在【小盲 SB】。有人加注到 2.5bb。你拿 A♠ A♥。", "hand": ["As", "Ah"], "board": [], "posId": "node-sb", "options": [{ "action": "3-bet 建池", "is_correct": true, "hp_change": 12, "sharky_emotion": "cool", "sharky_feedback": "AA 要建池。SB 拿 AA 必须 3-bet，不要平跟。不要为了「埋伏」放弃主动权。" }, { "action": "平跟 (Call)", "is_correct": false, "hp_change": -15, "sharky_emotion": "angry", "sharky_feedback": "AA 平跟等于送钱。3-bet 把底池做大，翻牌后继续拿价值。" }] },
  { "level_id": 821, "title": "【位置】BB 多人池 65s", "scenario": "你在【大盲 BB】。UTG 加注，两人跟注，你拿 6♥ 5♥。底池赔率不错。", "hand": ["6h", "5h"], "board": [], "posId": "node-bb", "options": [{ "action": "跟注看翻牌", "is_correct": true, "hp_change": 10, "sharky_emotion": "cool", "sharky_feedback": "多人池赔率好，65s 同花连张可跟注 set/顺子/同花。但不要为了底池硬防——若加注很大就弃。" }, { "action": "加注", "is_correct": false, "hp_change": -12, "sharky_emotion": "facepalm", "sharky_feedback": "BB 多人池 65s 跟注看翻牌是标准，加注没意义。" }] },
  { "level_id": 822, "title": "【位置】BTN 拿 99 前面两人跟注", "scenario": "UTG 加注，HJ 跟注，其他人弃牌。你在【BTN】拿 9♦ 9♣。", "hand": ["9d", "9c"], "board": [], "posId": "node-btn", "options": [{ "action": "加注 (3-bet) 隔离", "is_correct": true, "hp_change": 12, "sharky_emotion": "cool", "sharky_feedback": "加注可抢死钱、隔离成单挑或两人池，99 有牌力。跟注也可，但 3-bet 常更优。" }, { "action": "弃牌", "is_correct": false, "hp_change": -12, "sharky_emotion": "facepalm", "sharky_feedback": "99 在 BTN 对前位加注值得玩，加注或跟注都行。" }] },
  { "level_id": 823, "title": "【位置】UTG 加注被 3-bet 拿 JJ", "scenario": "你在 UTG 加注，有人 3-bet。你拿 J♦ J♣。", "hand": ["Jd", "Jc"], "board": [], "posId": "node-utg", "options": [{ "action": "跟注或 4-bet，不轻易弃", "is_correct": true, "hp_change": 12, "sharky_emotion": "cool", "sharky_feedback": "JJ 对 3-bet 通常跟注看翻牌，或 4-bet  bluff/价值。别随便弃给 3-bet——很多对手 3-bet 范围里有你领先的牌。" }, { "action": "弃牌", "is_correct": false, "hp_change": -15, "sharky_emotion": "angry", "sharky_feedback": "JJ 太强不能随便弃。跟注或 4-bet 根据筹码和对手决定。" }] },
  { "level_id": 824, "title": "【位置】位置好时偷盲范围", "scenario": "你在【BTN】，前面全弃。偷盲（加注）的范围应该比在 UTG 时？", "hand": [], "board": [], "posId": "node-btn", "options": [{ "action": "宽很多", "is_correct": true, "hp_change": 12, "sharky_emotion": "cool", "sharky_feedback": "位置好时偷盲范围可以放宽。BTN 对盲注是领地，哪怕是空气牌也能考虑偷一波。UTG 则要最紧。" }, { "action": "一样", "is_correct": false, "hp_change": -12, "sharky_emotion": "facepalm", "sharky_feedback": "位置决定范围。BTN 可偷更多，UTG 必须紧。" }] },

  // ========== 赔率 / 心理 / 纪律 各 6 题（Easy×2 + Medium×2 + Hard×2），825–842 ==========
  { "level_id": 825, "title": "【赔率】转牌听同花底池赔率", "scenario": "转牌圈，底池 100，对方下注 20。你差一张牌凑成同花（9 张补牌）。", "hand": ["As", "Ks"], "board": ["Qs", "Js", "2s", "8d"], "category": "赔率", "options": [{ "action": "跟注 (Call)", "is_correct": true, "hp_change": 12, "sharky_emotion": "cool", "sharky_feedback": "120 的池子让你掏 20 看河牌，这种数学题要是算错，建议去小学重读。" }, { "action": "弃牌 (Fold)", "is_correct": false, "hp_change": -10, "sharky_emotion": "facepalm", "sharky_feedback": "赔率足够，跟注看河牌是正解。弃牌等于白送底池。" }] },
  { "level_id": 826, "title": "【赔率】翻牌 22 对 All-in 赔率极差", "scenario": "翻牌圈，你拿口袋对 22。对方 All-in 200，底池共 210。你没击中三条。", "hand": ["2h", "2s"], "board": ["Ac", "Kd", "7s"], "category": "赔率", "options": [{ "action": "跟注 (Call)", "is_correct": false, "hp_change": -15, "sharky_emotion": "angry", "sharky_feedback": "你只有 12% 的胜率，却想赢 1:1 的钱？你不是在打牌，是在做慈善。" }, { "action": "弃牌 (Fold)", "is_correct": true, "hp_change": 12, "sharky_emotion": "cool", "sharky_feedback": "赔率极差，弃牌保命。小对子没中 set 别硬跟。" }] },
  { "level_id": 827, "title": "【心理】紧弱玩家河牌出 A 诈唬偷池", "scenario": "对方是非常胆小的「紧弱玩家」，河牌出了张 A。你手里啥也没有。", "hand": ["7h", "2d"], "board": ["As", "5d", "2s", "Jc", "Kc"], "category": "心理", "options": [{ "action": "下注 (Bet) 诈唬偷池", "is_correct": true, "hp_change": 12, "sharky_emotion": "laugh", "sharky_feedback": "对方怕 A 怕得要死，你吹口气他都能倒下。这种底池不偷，你留着过年吗？" }, { "action": "过牌 (Check)", "is_correct": false, "hp_change": -10, "sharky_emotion": "facepalm", "sharky_feedback": "紧弱面对 A 面会弃掉大量牌，不偷白不偷。" }] },
  { "level_id": 828, "title": "【心理】C-Bet 被跟转牌惊悚牌尊重", "scenario": "你持续下注被对方秒跟，转牌是一张极度危险的惊悚牌，对方突然领先下注。", "hand": ["Kh", "Qh"], "board": ["Ks", "8d", "2c", "As"], "category": "心理", "options": [{ "action": "跟注 (Call)", "is_correct": false, "hp_change": -12, "sharky_emotion": "angry", "sharky_feedback": "对方脸上写着「我中 A 了」。这时候还要硬刚，你是觉得对方在逗你玩吗？" }, { "action": "弃牌 (Fold)", "is_correct": true, "hp_change": 12, "sharky_emotion": "cool", "sharky_feedback": "尊重对手。惊悚牌上对方 donk，多半中了强牌，弃牌不丢人。" }] },
  { "level_id": 829, "title": "【纪律】AA 翻牌 89T 同花懂得放下", "scenario": "你拿 AA，翻牌出了 8-9-10 同花色。对方带头全押 500 BB。", "hand": ["As", "Ad"], "board": ["8c", "9c", "Tc"], "category": "纪律", "options": [{ "action": "跟注 (Call)", "is_correct": false, "hp_change": -20, "sharky_emotion": "angry", "sharky_feedback": "拿着两张 A 就像拿着传家宝？在这个面上，你这张传家宝可能连垃圾都不如。" }, { "action": "弃牌 (Fold)", "is_correct": true, "hp_change": 14, "sharky_emotion": "cool", "sharky_feedback": "懂得放下。顺面+同花面，AA 赢率惨不忍睹，弃牌是纪律。" }] },
  { "level_id": 830, "title": "【纪律】Tilt 连输三手强制冷静", "scenario": "你已经连续输了三手大牌，现在情绪非常上头（Tilt），想拿垃圾牌全押。", "hand": ["Jd", "4h"], "board": [], "category": "纪律", "options": [{ "action": "全押 (All-in)", "is_correct": false, "hp_change": -20, "sharky_emotion": "angry", "sharky_feedback": "关掉电脑，去洗把脸！带着这种情绪打牌，你就是全桌最好的「取款机」。" }, { "action": "弃牌 (Fold)", "is_correct": true, "hp_change": 14, "sharky_emotion": "cool", "sharky_feedback": "强制冷静。Tilt 时唯一正确动作就是弃牌，甚至离桌。" }] },

  { "level_id": 831, "title": "【赔率】两端顺子底池赔率不足", "scenario": "听两端顺子（8 张补牌），河牌还没发。底池 100，对方下注 80。", "hand": ["9h", "8h"], "board": ["7s", "6d", "2c", "Ks"], "category": "赔率", "options": [{ "action": "跟注 (Call)", "is_correct": false, "hp_change": -12, "sharky_emotion": "facepalm", "sharky_feedback": "你的胜率不到 18%，对方却要你付 44% 的底池份额。别对着顺子听牌流口水了，快跑！" }, { "action": "弃牌 (Fold)", "is_correct": true, "hp_change": 12, "sharky_emotion": "cool", "sharky_feedback": "不中即死。赔率不够就弃牌，别硬追。" }] },
  { "level_id": 832, "title": "【赔率】隐含赔率听小同花追肥羊", "scenario": "隐含赔率题。你听小同花，底池小。对方是超级大肥羊，只要你中了他就全押。", "hand": ["5s", "4s"], "board": ["As", "Ks", "2d", "Jh"], "category": "赔率", "options": [{ "action": "跟注 (Call)", "is_correct": true, "hp_change": 12, "sharky_emotion": "cool", "sharky_feedback": "虽然现在赔率一般，但对方兜里那叠厚钞票就是你的「隐含赔率」。追他！" }, { "action": "弃牌 (Fold)", "is_correct": false, "hp_change": -10, "sharky_emotion": "facepalm", "sharky_feedback": "肥羊会支付，隐含赔率够就可以跟。" }] },
  { "level_id": 833, "title": "【心理】半诈唬听花听顺主动进攻", "scenario": "半诈唬（Semi-Bluff）。你听花听顺，翻牌圈你是第一个行动。", "hand": ["Jh", "Th"], "board": ["9h", "8h", "2s"], "category": "心理", "options": [{ "action": "过牌 (Check)", "is_correct": false, "hp_change": -10, "sharky_emotion": "facepalm", "sharky_feedback": "既然有这么多补牌，为什么不主动出击？万一对方直接跑了，底池就是你的了。" }, { "action": "下注 (Bet)", "is_correct": true, "hp_change": 12, "sharky_emotion": "cool", "sharky_feedback": "主动进攻。半诈唬能抢池也能中牌拿价值，两全其美。" }] },
  { "level_id": 834, "title": "【心理】抓鸡河牌听牌全失败", "scenario": "抓鸡（Bluff Catching）。对手是激进狂，河牌所有听牌都失败了。", "hand": ["8s", "8d"], "board": ["Js", "7s", "2d", "3c", "4h"], "category": "心理", "options": [{ "action": "跟注 (Call)", "is_correct": true, "hp_change": 12, "sharky_emotion": "cool", "sharky_feedback": "对方的听牌全烂在手里了，这时候他只能靠推土机式的下注吓唬你。勇敢点，抓他！" }, { "action": "弃牌 (Fold)", "is_correct": false, "hp_change": -12, "sharky_emotion": "facepalm", "sharky_feedback": "抓空牌。河牌面听牌全死，对手大概率在诈唬，中对值得跟。" }] },
  { "level_id": 835, "title": "【纪律】顶对 AK 干燥河对方推两池", "scenario": "顶对掉坑。你拿 AK 击中 A，但对方在极度干燥的河牌圈突然推了 2 倍底池。", "hand": ["Ah", "Kd"], "board": ["As", "7d", "2c", "5h", "9s"], "category": "纪律", "options": [{ "action": "跟注 (Call)", "is_correct": false, "hp_change": -15, "sharky_emotion": "angry", "sharky_feedback": "干燥面上对方敢推两个底池，多半是中了 77 或 55 的暗三。忍痛割爱是懂哥的基本功。" }, { "action": "弃牌 (Fold)", "is_correct": true, "hp_change": 14, "sharky_emotion": "cool", "sharky_feedback": "识破隐藏超强牌。顶对弱踢脚面对超池要能弃。" }] },
  { "level_id": 836, "title": "【纪律】UTG AJo 被 3-bet 严守位置", "scenario": "面对 3-Bet，你手里是边缘手牌 AJo。你在枪口位（UTG）加注被反击。", "hand": ["Ac", "Js"], "board": [], "category": "纪律", "options": [{ "action": "跟注 (Call)", "is_correct": false, "hp_change": -12, "sharky_emotion": "facepalm", "sharky_feedback": "在枪口位拿 AJo 被 3-bet，你处于最烂的位置和最尴尬的手牌。不扔留着收尸吗？" }, { "action": "弃牌 (Fold)", "is_correct": true, "hp_change": 12, "sharky_emotion": "cool", "sharky_feedback": "严守位置纪律。UTG 被 3-bet 范围碾压，AJo 弃牌。" }] },

  { "level_id": 837, "title": "【赔率】MDF 顶对弱踢脚必须防御", "scenario": "面对比 1/2 底池略小的下注，你手里是顶对弱踢脚。根据 MDF（最小防御频率）理论。", "hand": ["Ah", "3h"], "board": ["Ac", "8d", "5s"], "category": "赔率", "options": [{ "action": "跟注 (Call)", "is_correct": true, "hp_change": 14, "sharky_emotion": "cool", "sharky_feedback": "在这种干燥面上，如果你连 A3 都弃掉，对方只要随便抓把空气就能把你偷到破产。" }, { "action": "弃牌 (Fold)", "is_correct": false, "hp_change": -14, "sharky_emotion": "angry", "sharky_feedback": "必须防御。MDF 要求你保留一定频率跟注，否则对方可以无脑诈唬。" }] },
  { "level_id": 838, "title": "【赔率】Overbet 抓鸡胜率要求 40%", "scenario": "面对超额下注（Overbet）2 倍底池。你怀疑对方在听牌失败后的诈唬，但胜率要求是多少？", "hand": ["Jc", "Jd"], "board": ["9s", "5h", "2d", "Kh", "Ad"], "category": "赔率", "options": [{ "action": "跟注 (Call)", "is_correct": false, "hp_change": -14, "sharky_emotion": "angry", "sharky_feedback": "面对超池，你得有 40% 以上的把握才能抓鸡。你的钩子（JJ）在这里比白纸厚不了多少。" }, { "action": "弃牌 (Fold)", "is_correct": true, "hp_change": 14, "sharky_emotion": "cool", "sharky_feedback": "胜率要求高达 40%。超池下注改变了赔率，JJ 常不够跟。" }] },
  { "level_id": 839, "title": "【心理】形象利用连续弃牌后抢劫", "scenario": "形象利用。你已经连续弃牌 20 手，形象极度稳健。此时你拿到空气牌。", "hand": ["2c", "7s"], "board": ["Qs", "9d", "4h"], "category": "心理", "options": [{ "action": "加注 (Raise)", "is_correct": true, "hp_change": 14, "sharky_emotion": "laugh", "sharky_feedback": "全桌都觉得你是铁桶，这时候你不「抢劫」一下，简直对不起你这张老实人的脸。" }, { "action": "弃牌 (Fold)", "is_correct": false, "hp_change": -12, "sharky_emotion": "facepalm", "sharky_feedback": "利用形象。紧形象后拿空气加注，对手很难跟。" }] },
  { "level_id": 840, "title": "【心理】Check-Raise 潮湿面识别陷阱", "scenario": "面对对手的过牌-回扣（Check-Raise）。这是一个非常潮湿的牌面，对方倾向于保护强牌。", "hand": ["Ac", "Kc"], "board": ["Qc", "Jc", "9h"], "category": "心理", "options": [{ "action": "跟注 (Call)", "is_correct": false, "hp_change": -15, "sharky_emotion": "angry", "sharky_feedback": "对方在这个面上敢反击，不是顺子就是暗三。你的 AK 也就是个看起来好看的艺术品。" }, { "action": "弃牌 (Fold)", "is_correct": true, "hp_change": 14, "sharky_emotion": "cool", "sharky_feedback": "识别深度陷阱。潮湿面 check-raise 多为强牌，AK 顶对常不够。" }] },
  { "level_id": 841, "title": "【纪律】非坚果同花防更高同花", "scenario": "弃掉同花。河牌出了第四张同花色，你拿的是非坚果同花，对方全押。", "hand": ["8s", "7s"], "board": ["As", "Ks", "4s", "Tc", "2s"], "category": "纪律", "options": [{ "action": "跟注 (Call)", "is_correct": false, "hp_change": -18, "sharky_emotion": "angry", "sharky_feedback": "你手里只有个 8 亮的同花，对方只要有张单 Q 就能把你吃干抹净。这种钱不能挣。" }, { "action": "弃牌 (Fold)", "is_correct": true, "hp_change": 14, "sharky_emotion": "cool", "sharky_feedback": "防范更高同花。非坚果同花面对全押要能弃。" }] },
  { "level_id": 842, "title": "【纪律】被高手针对换桌", "scenario": "职业选手的自律。你发现同桌有个高手完全看穿了你的打法，每手都在针对你。", "hand": [], "board": [], "category": "纪律", "options": [{ "action": "继续硬刚", "is_correct": false, "hp_change": -15, "sharky_emotion": "angry", "sharky_feedback": "打牌是为了赢钱，不是为了证明你比高手更聪明。去找比你菜的人玩，那才叫专业。" }, { "action": "换桌 (寻找更弱对手)", "is_correct": true, "hp_change": 14, "sharky_emotion": "cool", "sharky_feedback": "寻找更弱对手。被针对时换桌是职业自律，不是怂。" }] }
];

// 为每道题打上 chapter、difficulty、category（五维图数据源：优先题目自带 category，否则按 level_id 默认归类）
function getDefaultCategory(levelId) {
  if (levelId >= 801 && levelId <= 824) return '位置';
  var map = { 1: '纪律', 2: '纪律', 3: '位置', 4: '纪律', 5: '牌力', 6: '牌力', 7: '赔率', 8: '赔率', 9: '纪律', 10: '牌力', 11: '位置', 12: '牌力', 13: '赔率', 14: '心理', 101: '牌力', 102: '牌力', 103: '牌力', 104: '位置', 105: '位置', 106: '位置', 107: '纪律', 201: '纪律', 202: '赔率', 203: '赔率', 301: '心理', 302: '心理', 303: '心理', 401: '心理', 402: '位置', 403: '心理' };
  return map[levelId] || '牌力';
}
...
allQuestions.forEach(function (q, i) {
  ...
  else if (i < 245) q.chapter = '资深懂哥';   // 235-244 懂哥 10
  else if (i < 253) q.chapter = '纸面萌新';   // 245-252 位置 8
  else if (i < 261) q.chapter = '野生票友';   // 253-260 位置 8
  else if (i < 269) q.chapter = '资深懂哥';   // 261-268 位置 8
  else if (i < 275) q.chapter = '纸面萌新';   // 269-274 赔率/心理/纪律 Easy 6
  else if (i < 281) q.chapter = '野生票友';   // 275-280 赔率/心理/纪律 Med 6
  else if (i < 287) q.chapter = '资深懂哥';   // 281-286 赔率/心理/纪律 Hard 6
  else q.chapter = '资深懂哥';
  q.difficulty = q.chapter === '纸面萌新' ? 'easy' : q.chapter === '野生票友' ? 'medium' : 'hard';
  if (q.category == null || q.category === undefined) q.category = getDefaultCategory(q.level_id);
});
...
var SHORT_TITLES = [
  ...
  "枪口QJ","UTG+1 ATo","枪口最紧","BTN 72偷盲","大盲K9不硬防","小盲83弃","最好位置BTN","UTG KQ被3弃",
  "HJ AJo开池","CO KTs加注","BTN 96s偷","BTN T8偷盲","SB 22 3bet","BB Q9s跟","BTN 77跟UTG","HJ比UTG宽",
  "CO AQ隔离","BTN AJs对SB","隔离是单挑","SB AA 3bet","BB 65s多人","BTN 99加注","UTG JJ不弃","位置好偷宽",
  "转牌听花跟注","22赔率弃","紧弱河牌偷","惊悚牌尊重","AA 89T弃","Tilt弃牌",
  "两端顺弃","隐含赔率跟","半诈唬下注","抓鸡跟注","顶对弃两池","AJo 3bet弃",
  "MDF跟注","Overbet弃","形象抢劫","CR弃AK","非坚果花弃","高手换桌"
];
allQuestions.forEach(function (q, i) {
